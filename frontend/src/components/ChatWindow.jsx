...
function ImageGeneratingAnimation({ editing }) {
  const [step, setStep] = useState(0);
  const steps = editing
    ? ['Reading your photo...', 'Improving details...', 'Fixing lighting...', 'Almost done...']
    : ['Understanding your prompt...', 'Generating image...', 'Adding details...', 'Almost done...'];
    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="p-3 sm:p-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-1 bg-white dark:bg-white/[0.06] border border-zinc-200 dark:border-white/10 rounded-2xl px-2 py-1.5 shadow-lg backdrop-blur-s
